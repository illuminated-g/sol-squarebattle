...
5. You can run the Launch SquareBattle VI to be able to run games with your square that is being developed and run it against other provided or downloaded square teams.